<template>
    <AppLayout>
        <Head title="Buat Periode Survei" />
        ...
        <div class="space-y-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-gray-500 dark:text-gray-400 mt-1">
                        Atur jadwal dan target kelas untuk evaluasi
                    </p>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                >
                    ...
                    >
                        <h2 class="text-lg font-semibold text-white">
                            Target Kelas & Dosen ({{ form.targets.length }}
                            dipilih)
                        </h2>
                        ...
                        >
                            <table class="w-full text-left text-sm">
                                ...
                                >
                                    ...
                                    <tr v-if="kelasMatakuliahs.length === 0">
                                        <td
                                            colspan="4"
                                            class="px-4 py-8 text-center text-gray-500"
                                        >
                                            Tidak ada kelas tersedia untuk tahun
                                            akademik ini
                                        </td>
                                    </tr>
                                </tbody>
...
const form = useForm({
    ...
    tanggal_selesai: new Date(Date.now() + 14 * 24 * 60 * 60 * 1000)
        .toISOString()
        .split("T")[0],
    status: "draft",
    is_mandatory: false,
