<template>
    <div class="min-h-screen bg-gray-50 dark:bg-gray-950">
        ...
        <div class="lg:pl-72 flex flex-col min-h-screen">
            <!-- Top Navbar -->
            <header class="sticky top-0 z-40 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border-b border-gray-200 dark:border-gray-800">
                <div class="flex items-center justify-between h-16 px-4 lg:px-8">
                    ...
                    <div class="flex items-center gap-2 lg:gap-4">
                        ...
                        <!-- Notifications -->
                        <button class="relative p-2.5 rounded-xl text-gray-500 hover:text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-gray-200 dark:hover:bg-gray-800 transition-colors">
                        ...
                        <div class="relative">
                            ...
                            >
                                ...
                                <div class="hidden lg:block text-left">
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400 capitalize">{{ auth.user?.roles?.[0] || 'User' }}</p>
                                </div>
            ...
            <!-- Footer -->
            <footer class="py-4 px-4 lg:px-8 border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
                <p class="text-center text-sm text-gray-500 dark:text-gray-400">
                    © {{ new Date().getFullYear() }} SIAKAD Pascasarjana - Universitas Ibn Khaldun Bogor
                </p>
            </footer>
        </div>
