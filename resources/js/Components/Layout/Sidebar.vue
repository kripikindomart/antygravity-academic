<template>
    ...
    >
        <div class="flex flex-col h-full">
            <!-- Logo -->
            <div
                class="flex items-center justify-between h-16 px-6 border-b border-gray-200 dark:border-gray-800"
            >
                <Link href="/dashboard" class="flex items-center gap-3">
                    <div
                        class="w-10 h-10 bg-gradient-to-br from-primary-500 to-primary-700 rounded-xl flex items-center justify-center shadow-lg shadow-primary-500/30"
                    >
                        <svg
            ...
            <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                ...
                <template v-if="hasDynamicMenus">
                    <div
                        v-for="(items, section) in sidebarMenus"
                        :key="section"
                        class="mb-6"
                    >
                        <p
                            class="px-3 mb-3 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider"
                        >
                            {{ section }}
                        </p>
                        <NavItem
                ...
                <template v-else>
                    ...
                    <div class="mb-6">
                        ...
                        />
                        <NavItem
                            v-if="hasPermission('jadwal.view')"
                            href="/jadwal"
                            icon="calendar"
                            label="Jadwal Kuliah"
                        />
                        <NavItem
                            v-if="hasPermission('kurikulum.view')"
                            href="/kurikulum"
                            icon="academic"
                            label="Kurikulum OBE"
                        />
                    ...
                    <div
                        v-if="
                            hasPermission('absensi.view') ||
                            hasPermission('jurnal.view') ||
                            hasPermission('nilai.view')
                        "
                        class="mb-6"
                    >
                        <p
                        ...
                        <NavItem
                            v-if="hasPermission('absensi.view')"
                            href="/absensi"
                            icon="clipboard-check"
                            label="Absensi"
                        />
                        <NavItem
                            v-if="hasPermission('jurnal.view')"
                            href="/jurnal"
                            icon="document-text"
                            label="Jurnal Perkuliahan"
                        />
                        <NavItem
                            v-if="hasPermission('nilai.view')"
                            href="/nilai"
                            icon="chart-bar"
                            label="Nilai"
                        />
                        <NavItem
                            v-if="
                                hasPermission('survei.view') ||
                                hasPermission('survei.respond')
                            "
                            href="/survei"
                            icon="star"
                            label="Survei Evaluasi"
                        />
                    </div>
                    ...
                    <div
                        v-if="
                            hasPermission('prodi.view') ||
                            hasPermission('ruangan.view') ||
                    ...
                    >
                        ...
                        <NavItem
                            v-if="hasPermission('prodi.view')"
                            href="/prodi"
                            icon="building"
                            label="Program Studi"
                        />
                        <NavItem
                            v-if="hasPermission('ruangan.view')"
                            href="/ruangan"
                            icon="location"
                            label="Ruangan"
                        />
                        <NavItem
                            v-if="hasPermission('semester.create')"
                            href="/master/tahun-akademik"
                            icon="clock"
                            label="Tahun Akademik"
                        />
                        <NavItem
                            v-if="hasPermission('matakuliah.view')"
                            href="/mata-kuliah"
                            icon="book"
                            label="Mata Kuliah"
                        />
                    ...
                    <div
                        v-if="
                            hasPermission('laporan.view') ||
                            hasPermission('sk_mengajar.view')
                        "
                        class="mb-6"
                    >
                        <p
                        ...
                        <NavItem
                            v-if="hasPermission('laporan.view')"
                            href="/laporan"
                            icon="document-report"
                            label="Laporan"
                        />
                        <NavItem
                            v-if="hasPermission('absensi.rekap')"
                            href="/laporan/honorarium"
                            icon="currency"
                            label="Rekap Honorarium"
                        />
                        <NavItem
                            v-if="hasPermission('sk_mengajar.view')"
                            href="/sk-mengajar"
                            icon="document"
                            label="SK Mengajar"
                        />
                    ...
                    >
                        ...
                        <NavItem
                            v-if="hasPermission('survey.view')"
                            :href="route('survey.dashboard')"
                            icon="chart-bar"
                            label="Dashboard"
                        />
                        <NavItem
                            v-if="hasPermission('survey.manage')"
